...
```
dependencies {
    implementation 'ro.andob.jtextadventure:core:1.1.3'
    implementation 'ro.andob.jtextadventure:android:1.1.3'
    implementation 'ro.andob.jtextadventure:cli:1.1.3' //optional, for CLI
}
`````
